...
namespace Weather
{
    public struct WeatherObservation
    {
        ...
        public static WeatherObservation Parse(string text)
        {
            ...
            var pressure = float.Parse(data[(int)WeatherObservationMetrics.Barometric_Pressure],CultureInfo.InvariantCulture);
        ...
        public static bool TryParse(string text, out WeatherObservation wo)
        {
            ...
            if (!float.TryParse(data[(int)WeatherObservationMetrics.Barometric_Pressure].Replace(".", ","), out float pressure))
                return false;
